...
public class GameManager {
	...
	public static boolean isCollide(Entity e1, Entity e2) {
		...
		// if (Geometry.isPointInRect(e1.getX() - dx1, e1.getY() - dy1,
		// e2.getX() - dx2, e2.getY() - dy2, e2.getX() + dx2, e2.getY() + dy2))
		// {
		// return true;
		// }
		// if (Geometry.isPointInRect(e1.getX() - dx1, e1.getY() + dy1,
		// e2.getX() - dx2, e2.getY() - dx2, e2.getX() + dy2, e2.getY() + dy2))
		// {
		// return true;
		// }
		// if (Geometry.isPointInRect(e1.getX() + dx1, e1.getY() - dy1,
		...
		// return true;
		// }
		// if (Geometry.isPointInRect(e1.getX() - dx1, e1.getY(), e2.getX() -
		// dx2, e2.getY() - dy2, e2.getX() + dx2, e2.getY() + dy2)) {
		// return true;
		// }
		// if (Geometry.isPointInRect(e1.getX() + dx1, e1.getY() + dy1,
		// e2.getX() - dx2, e2.getY() - dx2, e2.getX() + dy2, e2.getY() + dy2))
		...
		// return true;
		// }
		// if (Geometry.isPointInRect(e1.getX(), e1.getY() - dy1, e2.getX() -
		// dx2, e2.getY() - dx2, e2.getX() + dy2, e2.getY() + dy2)) {
		// return true;
		// }
		// if (Geometry.isPointInRect(e1.getX(), e1.getY() + dy1, e2.getX() -
		// dx2, e2.getY() - dx2, e2.getX() + dy2, e2.getY() + dy2)) {
		...
		if (e1 instanceof Bullet) {
			...
			if (e1 instanceof BulletPassable) {
				...
				if (((Bullet) e2).getOwner().getName().equals(((Player) e1).getName())) {
					// check if player is bullet owner
					return;
				}
			...
			if (e2 instanceof Item) {
				...
				doCollision((Player) e1, (Entity) e2);
			}
		} else if (e2 instanceof Player) {
			if (e1 instanceof Item) {
				...
				doCollision((Player) e2, (Entity) e1);
			}
		}
	}
